                        ...
                        {!isLogin && (
                            <div className="mt-4 flex items-center space-x-2">
                                {[...Array(totalSteps)].map((_, index) => (
                                    <div
                                        key={index}
                                        className={`h-2 rounded-full flex-1 ${index + 1 <= currentStep ? 'bg-white' : 'bg-white/30'
                                            }`}
                                    />
                                ))}
                            </div>
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {jobTypes.map((type) => (
                                                    <button
                                                        ...
                                                        className={`px-3 py-1 rounded-full text-sm transition-colors duration-200 ${formData.preferredJobTypes.includes(type)
